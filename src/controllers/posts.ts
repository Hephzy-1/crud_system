...
export const createPost = asyncHandler(async (req: Request, res: Response, next: NextFunction) => {
  ...
  return res.status(201).json({ success: true, message: 'Post created successfully', post: blog });
});

export const getPostsByUserId = asyncHandler(async (req: Request, res: Response, next: NextFunction) => {
  ...
  res.status(200).json({ sucess: true, message: "Here is your post:", data: post });
});
...
export const getPosts = asyncHandler(async (req: Request, res: Response) => {
  ...
  return res.status(200).json({ success: true, message: 'Here is all the posts:', post });
});
...
export const update = asyncHandler(async (req: Request, res: Response, next: NextFunction) => {
  ...
  return res.status(200).json({ success: true, message: 'Post has been updated', post: pushUpdate });
});
